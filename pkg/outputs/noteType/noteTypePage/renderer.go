...
func (r *PageWriter) WriteOutput(w io.Writer, p NoteTypePage) error {

	if err := r.templ.ExecuteTemplate(w, "noteTypePage.gotsx", p.getTemplateData()); err != nil {
		return err
	}
...
func (r PageWriter) WriteToPath(p string, data NoteTypePage) {
